...
#[cfg(test)]
mod tests {
    use solana_sdk::{message::Message, pubkey::Pubkey, system_program, signature::{read_keypair, read_keypair_file, Keypair, Signer}, transaction::Transaction};
    use solana_client::{rpc_client::RpcClient, rpc_custom_error::JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_LEN_MISMATCH};
    ...
    fn airdrop() {
        ...
        //We're going to claim 2 devnet SOL tokens (2 bill lamports)
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("6YfTMxHeGhCE9GEKvkJGHPPQQpaanthDk1dAhnN7xENW").unwrap();
